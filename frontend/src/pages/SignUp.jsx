...
const SignUp = () => {
  ...
  const validateForm = () => {
    if (!formData.fullName.trim())
      return toast.error("Provide your Full Name!");
    if (!formData.email.trim()) return toast.error("Provide your Email!");
    if (!/\S+@\S+\.\S+/.test(formData.email))
      return toast.error("Invalid Email!");
    if (!formData.password) return toast.error("Provide your Password!");
      ...
      <div className="hidden lg:flex items-center justify-center bg-base-200 p-12">
        <div className="max-w-md text-center">
          ...
          <div className="space-y-4">
            ...
            {/* Social logos for smaller screens */}
            <div className="lg:hidden flex space-x-6">
              <FaFacebook className="size-7 text-primary hover:text-blue-600 transition-colors" />
              <FaInstagram className="size-7 text-primary hover:text-pink-600 transition-colors" />
              <FaGithub className="size-7 text-primary hover:text-gray-800 transition-colors" />
            </div>
          </div>
        </div>
      </div>
